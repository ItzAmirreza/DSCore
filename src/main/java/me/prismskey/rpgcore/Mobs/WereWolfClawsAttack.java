...
public class WereWolfClawsAttack {
    Random r = new Random();
    ...
    public void start(LivingEntity e) {
        ...
        if(potentialTargets.size() > 0) {
            ...
            randomTarget.sendMessage(ChatColor.RED + "The werewolf digs into you with its claws causing you to bleed.");
            ((Damageable) randomTarget).damage(6,e);
